...
public class SangPelempar {
    ...
    public void throwing(SangPelempar enemy){
        ...
        this.health -= (enemy.sandal.getDamageLemaparan() - this.pelindung.getDef(Random));
        System.out.printf("%s mengenai %s %s\n",this.nama, target, enemy.nama);
        
        enemy.health -= (this.sandal.getDamageLemaparan() - enemy.pelindung.getDef(Random));
