...
import TugasPraktikum4.login_app.models.Profile;
import TugasPraktikum4.login_app.models.User;
import TugasPraktikum4.login_app.utils.StringUtils;
...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {
            ...
            // (TAMBAHAN)   saat username tidak ditemukan
    ...
    private static void showRegisterMenu() {
         ...
         * diinput sebelumnya
         */
        // profile.set = new Profile(fullName, age, hobby);
